package src.examples.grid.mathProblemDistributed;
...
Class[][] m_argTypes;
  ...
  public void setUp(GPConfiguration a_conf, @SuppressWarnings("rawtypes") Class[] a_types, @SuppressWarnings("rawtypes") Class[][] a_argTypes,
