...
public class DeJong2Test {
    public static void main(String args[]) throws Exception {
        ...
        // 确定自己的适应度函数
        FitnessFunction mFitFunction = new DeJong2Function();
        conf.setFitnessFunction(mFitFunction);

        // 构建基因
        Gene[] mGene = new Gene[2];
        mGene[0] = new DoubleGene(conf, -2.048, 2.048);
        mGene[1] = new DoubleGene(conf, -2.048, 2.048);
